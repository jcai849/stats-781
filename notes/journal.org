* [[file:meeting_notes.org][Meetings]]
  :PROPERTIES:
  :CUSTOM_ID: meetings
  :END:
...
[[https://en.wikipedia.org/wiki/Anscombe's_quartet][Anscombe's Quartet]], where the base statistics leave a good deal of information
...
algorithm (pagerank studied in depth in STATS 320) - my exploration of
the package is documented [[./textrank_exploration.Rmd][here]]. At
...
[[file:summarisation_experimentation.Rmd][here]]
...
developed. All data is stored in the folder [[file:data][data]]
