...
** Topics
** Dissertation Work
   SCHEDULED: <2019-07-13 Sat 17:30>
   SCHEDULED: <2019-07-16 Tue>
- [ ] get_insight functions work on named column rather than "word" as
  default - word may still be the keyword argument
- [ ] additional processing functions to add/alter columns around
