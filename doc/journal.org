...
* Packaging 
  [2019-06-13 Thu]:
  - Read [[R-Packages][r-pkgs.org]]. Notes: A working prototype will be built before
  ...
  - Further intentions: a rigorous, clean implementation of grouping and
    ...
    operations.
  - Today's output consists of the following:
** [[file:~/curr/stats-781/src/prep-for-insight.R][Preparation]] [3/6]
   See [[Data types for implementation]] for the reasoning behind the
   standard dataframe output form.
   - [X] import_txt
   - [ ] import_csv
   - [X] get_sw
   - [X] remove_stopwords
   - [ ] lemmatise
   - [ ] add_doc
** [[file:~/curr/stats-781/src/word-insight.R][Word Insight]] [2/5]
...
** Document Insight [0/3]
   ...
   - [ ] tf_idf
   - [ ] between_phrase_lr
** [[file:~/curr/stats-781/src/vis-insight.R][Visualisation]] [2/7]
