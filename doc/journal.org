...
** Note on Non-Destructive Editing
 ...
 destructive edits, which is acceptable when the user is in an
 interactive R session with full control over every possible variable
 assignment, but not for development for a GUI user. Hence, we have
 made the explicit decision to have non-destructive transformations
 only, after hitting repeated roadblocks related to Destructive edits.
 Memory is cheap for computers, and summarisation functions can always
 be delayed, to retain as much information as possible. The concept of
 nondestructive edits is not new; graphic design relies upon it, with
 an example given for photoshop at the [[https://helpx.adobe.com/photoshop/using/nondestructive-editing.html][Adobe Website]]
...
concept. 
#+begin_src R :session rsession1 :tangle ~/inzightta/R/import-txt.R :eval never-export :exports both
  #' Import text file 
  #'
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/import-csv.R :eval never-export :exports both
  #' Import csv file
  #'
  #' @param filepath a string indicating the relative or absolute
  #'     filepath of the file to import
...
to csv.
#+begin_src R :session rsession1 :tangle ~/inzightta/R/import-excel.R :eval never-export :exports both
  #' Import excel file
  #'
  #' @param filepath a string indicating the relative or absolute
  #'     filepath of the file to import
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/import-files.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/text-prep.R :eval never-export :exports both
...
below.
#+begin_src R :session rsession1 :tangle ~/inzightta/R/stopwords.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/format-data.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/section.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/term-freq.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/get-bigram.R :eval never-export :exports both
  #' Determine bigrams
  #'
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/concat-walk.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/get-ngram.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/ngram-freq.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/keywords.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/term-sentiment.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/ma-term-sentiment.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/term-count.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/key-aggregates.R :eval never-export :exports both
...
case, AFINN.
#+begin_src R :session rsession1 :tangle ~/inzightta/R/aggregate-sentiment.R :eval never-export :exports both
...
*** TODO [#B] Word Correlation
 ...
 #+begin_src R :session rsession1 :tangle ~/inzightta/R/term-corr.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/get-insight.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/barplot.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/wordcloud.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/histogram.R :eval never-export :exports both
...
#+end_src
*** CLOSED Density
#+begin_src R :session rsession1 :tangle ~/inzightta/R/density.R :eval never-export :exports both
#' output a histogram of the distribution of some function of words
#'
#' @param .data the standard dataframe, modified so the last column
#'     is the output of some insight function (eg. output from
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/time-series.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/page-view.R :eval never-export :exports both
...
#+begin_src R :session rsession1 :tangle ~/inzightta/R/get-vis.R :eval never-export :exports both
...
Tangle files from =org= document with C-c C-v C-t (org-babel-tangle)

#+begin_src R :results output :colnames yes :hline yes :session rsession1 :tangle no :comments link :exports both :eval never-export
  package_path <- "~/inzightta"
  doc_path <- "~/stats-781/dissertation"
  setwd(package_path)
  usethis::use_pipe()
...
#+begin_src bash
  cd ~/stats-781/dissertation/
  ./symlink-r.sh
  mv inzightta_0.0.0.9000.pdf inzightta_manual.pdf
#+end_src
