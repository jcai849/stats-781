[2019-07-21 Sun]: GOTO [[#program-dependencies][Program Dependencies]] section, continue through Preparation, Insight, and Visualisation
* Table of Contents                                                     :TOC:
- [[#dissertation-due][Dissertation Due]]
- [[#colophon][COLOPHON]]
...
#+begin_src R :session rsession1 :tangle ~/inzightta-shiny/app.R
  library(shiny)
  library(inzightta)

  ui <- pageWithSidebar(
    headerPanel("iNZight Text Analytics"),
    sidebarPanel(),
    mainPanel()
  )
